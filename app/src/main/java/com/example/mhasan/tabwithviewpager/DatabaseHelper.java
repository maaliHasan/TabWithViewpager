...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String PHOTO_TABLE_CREATE = "create table photo ( ID INTEGER PRIMARY KEY, IMG text UNIQUE  not null,user_id INTEGER, FOREIGN KEY (user_id) REFERENCES user (ID));";
